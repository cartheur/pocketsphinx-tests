...
{
    /// <summary>
    /// The class reponsible for holding the values of how long the program has been online.
    /// </summary>
    public static class Alive
    {
        /// <summary>
        /// The total time alive.
        /// </summary>
        public static TimeSpan TimeAlive { get; set; }
        /// <summary>
        /// Placeholder for the time alive variable.
        /// </summary>
        public static TimeSpan TimeAliveVariable { get; set; }
        /// <summary>
        /// Check whether or not the animal is alive.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Store the alive value as a component of a transcript file.
        /// </summary>
        public static void StoreValue()
        {
            Logging.RecordTranscript("", true);
        }
    }
    /// <summary>
    ...
    public static class Logging
    {
        ...
        public static void WriteLog(string message, LogType logType, LogCaller caller)
        {
            ...
            switch (logType)
            {
                ...
                case LogType.Information:
                    stream.WriteLine(DateTime.Now + " - " + message + ". INFO - This was called from the class " + caller + ".");
                    break;
        ...
        /// </summary>
        /// <param name="message">The message to save in transcript format.</param>
        /// <param name="alive">If the incoming message is from the alive counter.</param>
        public static void RecordTranscript(string message, bool alive = false)
        {
            ...
            try
            {
                ...
                if (alive)
                {
                    stream.WriteLine(DateTime.Now + " - " + "Information: Presence online for -- " + Alive.TimeAlive);
                }
                stream.Close();
            }
            catch (Exception ex)
